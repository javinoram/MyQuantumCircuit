...
std::tuple<std::string, std::complex<double>> OneQubit::aplicar_operador(std::string estado, std::complex<double> prob){
  std::cout << "El operador se ejecuto sobre " << estado << std::endl;
  return {estado, prob};
};
...
std::tuple<std::string, std::complex<double>> TwoQubit::aplicar_operador(std::string estado, std::complex<double> prob){
  std::cout << "El operador se ejecuto sobre " << estado << std::endl;
  return {estado, prob};
};
...
std::complex<double> RxGate::accion(std::string estado, std::complex<double> prob){
...
std::complex<double> RyGate::accion(std::string estado, std::complex<double> prob){return prob;};
...
std::complex<double> RzGate::accion(std::string estado, std::complex<double> prob){return prob;};



HGate::HGate( const int indice ): OneQubit(indice){};
HGate::~HGate(){std::cout<<"Destructor Hadamard"<<std::endl;};
std::complex<double> HGate::accion( std::string estado, std::complex<double> prob ){return prob;};
